...
$causessql ="SELECT * from causes ORDER BY Id ASC";
$causes = mysql_query($causessql) or die(mysql_error());
$projects ="SELECT * from projects ORDER BY Id ASC";
$projectssql = mysql_query($projects) or die(mysql_error());
$testimonials ="SELECT * FROM testimonials";
$testimonialssql = mysql_query($testimonials) or die(mysql_error());
$news ="SELECT * FROM news";
$latestnews = mysql_query($news) or die(mysql_error());
$gallerysql ="SELECT * from gallery ORDER BY Id ASC";
$galleryresult = mysql_query($gallerysql) or die(mysql_error());
?>
  <!-- Start main-content -->
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              ?>
            <!-- SLIDE 2 -->
              <li data-index="rs-<?php echo $i; ?>" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="admin/images/slider/100/<?php echo $result['image'];?>" data-rotate="0" data-saveperformance="off" data-title="Slide <?php echo $i; ?>" data-description="">
                <!-- MAIN IMAGE -->
                <img src="admin/images/slider/1500/<?php echo $result['image']; ?>"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent pl-20 pr-20"
                  ...
                  data-splitout="none" 
                  data-responsive_offset="on"
                  style="z-index: 7; white-space: nowrap; font-weight:600; border-radius: 30px;"><?php echo $result['subtitle']; ?> 
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="owl-carousel-1col owl-dots-bottom-right" data-dots="true">
                <?php 
                 $i=1;
                while ($resultcauses = mysql_fetch_array($causes)) {
            ?>
                <div class="item">
                  <div class="row-fluid">
                    <div class="col-md-5">
                      <img src="admin/images/causes/500/<?php echo $resultcauses['image']; ?>" alt="">
                    </div>
                    <div class="col-md-7">
                      <h4 class="mt-0 mb-0 text-black-666">Featured Causes:</h4>
                      <h2 class="line-bottom mt-0"><?php echo $resultcauses['title']; ?></h2>
                      
                <p align="justify"><?php echo $resultcauses['description']; ?></p>
          ...
          <div class="row mtli-row-clearfix">
           ...
           <!----test---->
            <?php 
                 $i=1;
                 $j=4;
                while ($projectsresult = mysql_fetch_array($projectssql)) {
                  //$per = $projectsresult['raisedamount']/$projectsresult['goalamount']*100;
              ?>
            <div class="col-sm-3 col-md-3 col-lg-3 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="causes maxwidth500 mb-sm-50">
                <div class="thumb">
                  <a href="projectdetails.php?pId=<?php echo $projectsresult['Id']; ?>"><img class="img-fullwidth" alt="" src="admin/images/projects/500/<?php echo $projectsresult['image']; ?>"></a>
                  <!-- <div class="donate-piechart">
                    <div class="piechart-block">
                      <div class="piechart" data-barcolor="#ccc" data-trackcolor="#fff" data-percent="<?php echo $per; ?>" data-linewidth="8">
                ...
                <div class="causes-details clearfix">
                  <div class=" p-30 p-sm-15 bg-lighter">
                    <h4><a href="projectdetails.php?pId=<?php echo $projectsresult['Id']; ?>"><?php echo $projectsresult['pname']; ?></a></h4>
                    <p align="justify"><?php echo $projectsresult['shortdescription']; ?></p>
                     <a class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10" href="projectdetails.php?pId=<?php echo $projectsresult['Id']; ?>">Donate Now</a>
                  </div>
                  <!-- <div class="mt-10 p-30 pt-10 pb-20 p-sm-15 bg-lighter">
                    <ul class="list-inline clearfix mt-10">
                      <li class="pull-left flip pr-0">Raised: <span class="font-weight-700 font-"><?php //echo $projectsresult['raisedamount']; ?></span></li>
                      <li class="text-theme-colored pull-right flip pr-0">Goal: <span class="font-weight-700"><?php //echo $projectsresult['goalamount']; ?></span></li>
                    </ul>
                  </div> -->
                </div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-md-7 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              ...
              <div id="grid" class="portfolio-gallery grid-4 gutter clearfix">
               ...
               <?php 
                 $i=1;
                while ($resultgallery = mysql_fetch_array($galleryresult)) {
               ?>

                <!-- Portfolio Item Start -->
                <div class="portfolio-item photography">
                  <div class="thumb">
                    <img class="img-fullwidth" src="admin/images/gallery/50/<?php echo $resultgallery['Image']; ?>" alt="project">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="social-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="admin/images/gallery/origional/<?php echo $resultgallery['Image']; ?>"><i class="fa fa-plus"></i></a>
      ...
      <div class="container pb-0">
        ...
        <div class="row">
          <div class="col-md-12 mb-30">
            ...
            <?php 
                 $i=1;
                while ($resulttestimonialssql = mysql_fetch_array($testimonialssql)) {
              ?>
              <div class="item">
                <div class="testimonial pt-10">
                  <div class="thumb pull-left mb-0 mr-0 pr-20">
                    <img width="75"  class="img-circle" alt="" src="admin/Images/matureman.png">
                  </div>
                  <div class="ml-100 ">
                    <h4 class="mt-0 font-weight-300"><?php echo $resulttestimonialssql['description']; ?></h4>
                    <p class="author text-theme-colored mt-20">-<?php echo $resulttestimonialssql['username']; ?></p>
                  </div>
                </div>
              </div>
            <?php
    ...
    <section id="blog">
      <div class="container">
        ...
        <div class="section-content">
          ...
          <?php 
                 $i=1;
                while ($latestnewsresult = mysql_fetch_array($latestnews)) {
              ?>
              ...
              <article class="post clearfix mb-sm-30 bg-lighter">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
                    <img src="admin/Images/news/250/<?php echo $latestnewsresult['pic']; ?>" alt="" class="img-responsive img-fullwidth"> 
                  </div>
                </div>
                <div class="entry-content p-20 pr-10">
                  <div class="entry-meta media mt-0 no-bg no-border">
                    <div class="entry-date media-left text-center flip bg-theme-colored pt-5 pr-15 pb-5 pl-15">
                      <ul>
                        <li class="font-16 text-white font-weight-600 border-bottom"><?php 
                        $datenews = $latestnewsresult['cdate'];
                        echo substr($datenews, 8,8);

                        ?></li>
                        <li class="font-12 text-white text-uppercase">
                        <?php  
                          $monthNum  = date("m", strtotime($datenews));
                    ...
                    <div class="media-body pl-15">
                      <div class="event-content pull-left flip">
                        <h4 class="entry-title text-white text-uppercase m-0 mt-5"><a href="#"><?php echo $resulttestimonialssql['title']; ?></a></h4>
                        <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-theme-colored"></i> 214 Comments</span>                       
                        <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Likes</span>                       
                      </div>
                    </div>
                  </div>
                  <p class="mt-10"><?php echo $latestnewsresult['description']; ?></p>
