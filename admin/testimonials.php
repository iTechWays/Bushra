...
$erroremail = "Testmonilas insert Succsessfully";
}
if(isset($_REQUEST['del']) == "Succsess"){
$erroremail = "Testmonilas Delete Succsessfully";
}
if(isset($_REQUEST['update']) == "Succsess"){
$erroremail = "Testmonilas update Succsessfully";
}
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Testimonal List</h4>
                                </div>
...
text-align: center;margin-top: 10px;"><?php if(isset($erroremail)){echo $erroremail;} ?></p></span>
                                    <table id="basic-datatables" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                     <a href="addtestimonials.php"><button type="button" class="btn btn-success mr5 mb10" style="float: right;margin-right: 17px !important;">Add Testimonals</button></a>
                                        <thead>
                                            <tr>
                                                <th>TMID</th>
                                                <th>User Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="edittestimonials.php?eId=<?php echo $result['Id'];?>"><i class="fa fa-edit" style="color: #439943;font-size: 20px;"></i></a>  <a href="deletetestmonial.php?dId=<?php echo $result['Id'];?>" onclick='return deletconfirm();'><i class="icomoon-icon-remove-2" style="color: red;font-size: 20px;"></i></a></td>
                                            </tr>
                                            <?php
                                                  $i++;
                                                }
