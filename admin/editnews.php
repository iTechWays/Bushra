...
$newsdetails = mysql_fetch_array($news);
?>
            <!--Body content-->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-body pt0 pb0">
                                    <form id="validate" class="form-horizontal group-border stripped" action="updatenews.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="text" class="col-lg-2 col-md-3 control-label">News Title</label>
                                            <div class="col-lg-10 col-md-9">
                                                <input id="text" type="text" name="title" class="form-control required" value="<?php echo $newsdetails['title'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <textarea class="form-control" name="description" id="textarea" rows="4"><?php echo $newsdetails['description'];?></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                ...
                                                <img id="myImg" src="images/news/100/<?php echo $newsdetails['pic'];?>" alt="your image" style="padding-top: 10px;width: 100px;" />
                                            </div>
                                        </div>
                                        <!-- End .form-group  -->
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-offset-2">
                                                <input type="hidden" name="newsId" value="<?php echo $newsdetails['Id']; ?>"/>
