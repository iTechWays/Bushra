...
$sliderId = $_REQUEST['eId'];
$sliders =mysql_query("SELECT * FROM slider where Id=$sliderId");
$slidersdetails = mysql_fetch_array($sliders);
?>
            <!--Body content-->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Edit Sliders</h4>
                                </div>
                                <div class="panel-body pt0 pb0">
                                    <form  class="form-horizontal group-border stripped" id="register-form"  action="updateslider.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="text" class="col-lg-2 col-md-3 control-label">Slider Title</label>
                                            <div class="col-lg-10 col-md-9">
                                                <input  type="text" class="form-control required"name="title" value="<?php echo $slidersdetails['title'];?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <input  type="text" class="form-control required" name="subtitle" value="<?php echo $slidersdetails['subtitle'];?>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <textarea class="form-control" name="description" id="textarea" rows="4"><?php echo $slidersdetails['description'];?></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <input type='file' name="image"/> <img id="myImg" src="images/slider/100/<?php echo $slidersdetails['image'];?>" alt="your image" style="padding-top: 10px;width: 100px;" />
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-lg-offset-2">
                                                <input type="hidden" name="sliderId" value="<?php echo $slidersdetails['Id']; ?>"/>
...
$(document).ready(function()
{
        ...
        ({
                ...
                messages: 
                {
                    ...
                    description: "Please enter TitleDescription"
                }
