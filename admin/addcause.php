...
text-align: center;margin-top: 10px;"><?php if(isset($erroretitle)){echo $erroretitle;} ?></p></span>
                                    <form  class="form-horizontal group-border stripped" id="project-form"  action="insert_causes.php"  method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <textarea class="form-control" name="desc" id="textarea" rows="4"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <input type='file' name="casuesimage"/> <br/> <img id="myImg" src="images/defaultgallery.jpg" alt="your image" width="100px" />
                                            </div>
                                        </div>
