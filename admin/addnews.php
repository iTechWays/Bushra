                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-body pt0 pb0">
                                    <form class="form-horizontal group-border stripped" id="register-form"  action="insertnews.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="text" class="col-lg-2 col-md-3 control-label">News Title</label>
                                            <div class="col-lg-10 col-md-9">
                                                <input id="text" type="text" class="form-control required" name="title">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <input type='file' name="image"/> <br/> <img id="myImg" src="images/defaultgallery.jpg" alt="your image" width="100px" />
                                            </div>
                                        </div>
                                        <!-- End .form-group  -->
...
$(document).ready(function()
{
        ...
        ({
                ...
                messages: 
                {
                    ...
                    description: "Please enter News Description"
                }
