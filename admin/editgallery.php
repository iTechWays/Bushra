...
$gId = $_REQUEST['eId'];
$galleryinfo =mysql_query("SELECT * FROM gallery where Id='$gId'");
$gallerydetails = mysql_fetch_array($galleryinfo);
?>
            <!--Body content-->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-body pt0 pb0">
                                    <form  class="form-horizontal group-border stripped" action="updategallery.php?id=<?php echo $gId; ?>" method="post" enctype="multipart/form-data">
                                         <div class="form-group">
                                            <label for="image" class="col-lg-2 col-md-3 control-label">Pic Upload:</label>
                                            <div class="col-lg-10 col-md-9">
                                                <input type='file' name="galleryimage"/> <img id="myImg" src="images/gallery/100/<?php echo $gallerydetails['Image'];?>" alt="your image" style="padding-top: 10px;width: 100px;" />
                                            </div>
                                        </div>
                                        <!-- End .form-group  -->
                                        <div class="form-group">
