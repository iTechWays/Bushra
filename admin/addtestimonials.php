                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-body pt0 pb0">
                                    <form  class="form-horizontal group-border stripped" id="register-form"  action="inserttestmonial.php" method="post">
                                        <div class="form-group">
                                            <label for="text" class="col-lg-2 col-md-3 control-label">User Name</label>
                                            <div class="col-lg-10 col-md-9">
                                                <input id="text" type="text" class="form-control required" name="username">
                                            </div>
                                        </div>
                                        <!-- End .form-group  -->
                                        <div class="form-group">
...
$(document).ready(function()
{
        ...
        ({
                ...
                messages: 
                {
                    ...
                    description: "Please enter testmonial"
                }
