            ...
            <div id="content" class="page-content clearfix">
                <div class="contentwrapper">
                    ...
                    <div class="heading">
                        ...
                        <div class="search">
                            <!-- .search -->
                            <form id="searchform" class="form-horizontal" action="insert_project.php"  method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelClose panelRefresh">
                                ...
                                <div class="panel-body pt0 pb0">
                                    <form id="project-form" class="form-horizontal group-border stripped" role="form" action="insert_project.php"  method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="text" class="col-lg-2 col-md-3 control-label">Project name</label>
                                            <div class="col-lg-10 col-md-9">
                                                <input id="text" type="text" name="pname" class="form-control required">
                                            </div>
                                        </div>
                                        
                                        
                                        <div class="form-group">
                                            <label for="textarea" name="desc" class="col-lg-2 col-md-3 control-label">Short Description</label>
                                            <div class="col-lg-10 col-md-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <textarea id="summernote" name="desc" required></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <input type='file' name="projectimage"/> <br/> <img id="myImg" src="images/defaultgallery.jpg" alt="your image" width="100px" />
                                            </div>
                                        </div>

                                        <!-- <div class="form-group">
                                            <label for="text" class="col-lg-2 col-md-3 control-label">Project Goal Amount</label>
                                            <div class="col-lg-10 col-md-9">
                                                <input  type="text" name="gamount" class="form-control required">
                                            </div>
                                        </div> -->
                                        <!-- End .form-group  -->
                                        <!-- End .form-group  -->
...
$("#project-form").validate
        ({
                ...
                messages: 
                {
                    ...
                    shortdesc: {
                        required: "Please provide a little description",
                        minlength: "Your description must be at least 100 characters long",
                        maxlength: "Your description must not be more than 100 characters"
                    },
