           ...
           <!----test---->
            ...
            <div class="col-sm-3 col-md-3 col-lg-3 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="causes maxwidth500 mb-sm-50">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="admin/images/projects/500/<?php echo $projectsresult['image']; ?>">
                ...
                <div class="causes-details clearfix">
                  <div class=" p-30 p-sm-15 bg-lighter">
                    <h4><a href="#"><?php echo $projectsresult['pname']; ?></a></h4>
                    <p align="justify"><?php echo $projectsresult['description']; ?></p>
