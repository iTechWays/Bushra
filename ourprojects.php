                  ...
                  <div class="col-sm-6">
                    <div class="form-group mb-20">
                      ...
                      <select name="item_name" class="form-control">
                        <?php 
                        $projectsname ="SELECT * from projects ORDER BY Id ASC";
                        $projectsnamesql = mysql_query($projectsname) or die(mysql_error());
                          while ($projectsnamesr = mysql_fetch_array($projectsnamesql)) {
                          ?>
                          <option value="<?php echo $projectsnamesr['Id']; ?>"><?php echo $projectsnamesr['pname']; ?></option>
                          <?php
                           }
                          ?>
                      </select>
