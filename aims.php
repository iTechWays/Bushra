...
<!-- Page Title -->
<title>Bushra Charitable Trust</title>
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-stellar-background-ratio="0.5" data-bg-img="http://placehold.it/1920x1280">
      <div class="container pt-100 pb-50">
        ...
        <div class="section-content pt-100">
          <div class="row"> 
            <div class="col-md-12">
              <h3 class="title text-white">AIMS & OBJECTIVES</h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="section-content">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="thumb">
			  <?php if($imga!=''){ ?>
 <img style="width:360px;height:300px" src="http://localhost/backup_bushra/images/avatar/<?php  echo $imga; ?>"  >

			  <?php } else {?>
                   <!--<img alt="" src="http://placehold.it/350x300" class="img-fullwidth">-->
         ...
         <!-- <div class="row mt-40">
            <div class="col-md-4">
              <div class="icon-box p-0">
                ...
                <div class="ml-120">
                  <h5 class="icon-box-title mt-15 mb-10 text-uppercase">Food</h5>
            ...
            <div class="col-md-4">
              <div class="icon-box p-0">
                ...
                <div class="ml-120">
                  <h5 class="icon-box-title mt-15 mb-10 text-uppercase">Health</h5>
                  <p class="text-gray">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="icon-box p-0">
                ...
                <div class="ml-120">
                  <h5 class="icon-box-title mt-15 mb-10 text-uppercase">Accomodation</h5>
                  <p class="text-gray">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                </div>
              </div>
            </div>
    ...
    <section class="divider parallax layer-overlay overlay-deep" data-bg-img="http://placehold.it/1920x1280" data-stellar-background-ratio="0.5">
      <div class="container">
